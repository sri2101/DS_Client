...
//           <p className="text-base line-through text-gray-500">₹{originalPrice.toLocaleString()}</p>
//           <p className="text-4xl font-extrabold text-black leading-snug">
//             ₹{discountedPrice.toLocaleString()}{" "}
//             <span className="text-base font-semibold text-black">Per Person</span>
//           </p>

//           {emiOptions?.plans?.length > 0 && (
//             <div className="flex items-center gap-1.5 mt-2 text-sm text-green-600">
//               <CreditCard className="w-4 h-4" />
//               <span>
//                 No Cost EMI Starts from ₹
//                 {emiOptions.plans[emiOptions.plans.length - 1].amount.toLocaleString()}
//               </span>
//               <button
...
//             <span className="bg-blue-100 text-blue-700 px-3 py-1 rounded-full text-sm">No Cost EMI</span>
//             <span className="bg-gray-100 text-gray-700 px-3 py-1 rounded-full text-sm">Standard EMI</span>
//           </div>
